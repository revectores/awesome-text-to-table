...
2. [CT-Eval - Benchmarking Chinese Text-to-Table Performance in Large Language Models](http://arxiv.org/pdf/2405.12174v1)
3. [Evaluating Structured Decoding for Text-to-Table Generation - Evidence from Three Datasets](http://arxiv.org/pdf/2508.15910v1)
4. [Is This a Bad Table? A Closer Look at the Evaluation of Table Generation from Text](http://arxiv.org/pdf/2406.14829v3)
5. [Struc-Bench - Are Large Language Models Really Good at Generating Complex Structured Data?](http://arxiv.org/pdf/2309.08963v3)
6. [TABLECODER - Table Extraction from Text via Reliable Code Generation](https://aclanthology.org/2025.acl-industry.98.pdf)
7. [TabXEval - Why this is a Bad Table? An eXhaustive Rubric for Table Evaluation](http://arxiv.org/pdf/2505.22176v2)
